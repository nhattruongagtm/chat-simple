...
import { requestSendMessageSuccess } from "../../features/chat/chatSlice";
...
const InputFrame = (props: InputFrameProps) => {
  ...
  const handleSendMessage = (e: React.FormEvent<HTMLFormElement>) =>{
    ...
    dispatch(requestSendMessageSuccess(chatItem))
    setInputText('')
  }
  ...
  return (
    <form className="input__chat" onSubmit={handleSendMessage}>
      ...
      <input type="text" placeholder="Type your message..." value={inputText} onChange={(e)=>setInputText(e.target.value)}/>
